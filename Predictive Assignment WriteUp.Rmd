...
### show full results
rfPred <- predict(fitModelFullBlown, newdata = testing.clean, type = "class")
...
ddply(training.clean,.(classe),function(x){return(x[1,])})
#do.call(rbind, lapply(splits, function(x) x[1,]))
